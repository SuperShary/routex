            ...
            <div className="mx-auto max-w-5xl px-6">
              <div className="sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  ...
                  verifies outputs—no prompt skills required. Say it. We spec it. Then ship it.
                </TextEffect>
                ...
                >
                  ...
                  >
                    <Link href="/app/playground">
                      <span className="text-nowrap">See Playground</span>
                    </Link>
                  </Button>
                </AnimatedGroup>
              </div>
              ...
              <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                ...
                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-5xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                  <Image
                    ...
                    src="/app-ui.png"
                    alt="RouteX dashboard interface"
                    width="2700"
                    height="1440"
                  />
                </div>
          ...
          <div className="group relative m-auto max-w-5xl px-6">
            <div className="absolute inset-0 z-10 flex scale-95 items-center justify-center opacity-0 duration-500 group-hover:scale-100 group-hover:opacity-100">
              ...
              >
                <span>
                  {" "}
                  Trusted by teams building the future of AI applications at:
                </span>
